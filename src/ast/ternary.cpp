...
CompiledValue TernaryExpression::Compile(const letsjit::compilation::Context & ctx) const {
  ...
  llvm::PHINode* phi = ir_builder.CreatePHI(if_true_val.value->getType(), 2, "iftmp");
